...
$datum=mysql_real_escape_string($_REQUEST['datum']);

mysql_query("update dev_nieuws set datum='$datum' where id='$id'");
mysql_query("update nieuws set datum='$datum' where id='$id'");

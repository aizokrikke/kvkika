...
<?php
	$ores=db_query("select id, naam, tijd from docs where verwijderd!='j' order by naam, tijd desc");
	while ($or=db_row($ores)) {
?>
...
?>        
     ...
     <table>
     <?php
	 	$dres=db_query("select docs.id, docs.naam, docs.bestand, docs.doctype, doctypes.icon, docs.eigenaar, docs.tijd from draaiboek_docs, docs, doctypes 

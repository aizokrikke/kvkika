...
$getfield = '?q=#bergop033+OR+#debergop333+OR+#kinderenvoorkika+OR+kindvoorkika';
...
echo "<div class=\"twitter_header\"><strong>@Kindvoorkika</strong> <div class=\"twitter_button\"><a href=\"http://twitter.com/kindvoorkika\" target=\"_blank\"><img src=\"/img/twitter/logo.png\" width=\"16\" height=\"13\"></a></div>
...
foreach ($r->statuses as $key=>$rec)
  { 
	...
	echo "<div class=\"twitter_user\">";
  	...
  	echo "<a href=\"https://www.twitter.com/".$rec->user->name."\"><strong>".utf8_decode($rec->user->name)."</strong></a><br>"; 
	echo "<a href=\"https://www.twitter.com/".$rec->user->name."\">@".utf8_decode($rec->user->screen_name)."</a><br>";

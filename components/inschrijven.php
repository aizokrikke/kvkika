...
?>
    ...
    <?php
        ...
        case 'bevestig':
            ...
            $dr=db_row("select personen.voornaam, personen.voorvoegsel, personen.achternaam, personen.geslacht, deelnemers.pagina, deelnemers.categorie from personen, deelnemers where deelnemers.id='$id' and personen.id=deelnemers.persoon and deelnemers.verwijderd!='j' and personen.verwijderd!='j'");
            $soort = $dr[5];
            if ($soort != 'estafette') {
                $naam = $dr[0];
                if (!empty($dr[1])) {
    ...
    <?php if ($soort != 'estafette') { ?>
        ...
        <select name="geb_maand" id="geb_maand">
            ...
            <option value="1" <?php if ($geb_maand == '1') {
                ?> selected="selected"<?php
            } ?>>januari</option>
            <option value="2" <?php if ($geb_maand == '2') {
                ?> selected="selected"<?php
            } ?>>februari</option>
            <option value="3" <?php if ($geb_maand == '3') {
                ?> selected="selected"<?php
            } ?>>maart</option>
            <option value="4" <?php if ($geb_maand == '4') {
                ?> selected="selected"<?php
            } ?>>april</option>
            <option value="5" <?php if ($geb_maand == '5') {
                ?> selected="selected"<?php
            } ?>>mei</option>
            <option value="6" <?php if ($geb_maand == '6') {
                ?> selected="selected"<?php
            } ?>>juni</option>
            <option value="7" <?php if ($geb_maand == '7') {
                ?> selected="selected"<?php
            } ?>>juli</option>
            <option value="8" <?php if ($geb_maand == '8') {
                ?> selected="selected"<?php
            } ?>>augustus</option>
            <option value="9" <?php if ($geb_maand == '9') {
                ?> selected="selected"<?php
            } ?>>september</option>
            <option value="10" <?php if ($geb_maand == '10') {
                ?> selected="selected"<?php
            } ?>>oktober</option>
            <option value="11" <?php if ($geb_maand == '11') {
                ?> selected="selected"<?php
            } ?>>november</option>
            <option value="12" <?php if ($geb_maand == '12') {
                ?> selected="selected"<?php
            } ?>>december</option>
        </select>
        </div>
        ...
        <div class="formitem_small">
        <span class="body"><input type="radio" name="geslacht" value="m" <?php if ($geslacht == 'm') {
            ?> checked="checked"<?php
        } ?> id="geslacht" /> jongen
        <input type="radio" name="geslacht" value="v" <?php if ($geslacht == 'v') {
            ?> checked="checked"<?php
        } ?> /> meisje </span>
        </div>
        <div style="clear:both"></div>
    ...
    ?>
        ...
        <select name="school" id="school">
            <option value=""></option>
            <option value="andere" <?php if ($school == 'andere') {
                ?> selected="selected"<?php
        ...
        ?>
            <option value="<?php echo $sr[0];?>" <?php if ($sr[0] == $school) {
                ?> selected="selected"<?php
                } ?>><?php echo stripslashes($sr[1]); ?></option>
        <?php
             } // while
        ?>
        </select>
